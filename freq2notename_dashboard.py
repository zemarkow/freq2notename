...
#
# Graphical user interface (GUI) for the author's freq2notename tools.
#
# Update Log:
#
# - 5/26/2024: Force key signature guess after final frequency-to-note name
# conversion even if key signature was guessed once before first conversion
# to handle "Auto" enharmonic prefereces.  Done to handle fringe cases where
# initially guessed key signature may not have been optimal.
#
# - 5/25/2024: Now import from freq2notename.utils to work with freq2notename
# as a Python package.
#
# - 5/24/2024: Adjusted some initial widget sizes to work better on Windows OS.
# Also added minsize to several more of the main text box-surrounding frames'
# grid configurations. Also added a block of code that sets the initial
# window size based on screen dimensions to stop overflow on Windows.
#
# - 5/8/2024: Added support for fancy Unicode flat (♭) and sharp (♯) symbols.
#
# - 4/25/2024 - 4/28/2024: Added preference controls for transposition.
#
